      ...
      <div class="viewport">
        ...
        <md-list class="md-double-line">
          ...
          <md-list-item>
            ...
            <div class="md-list-item-text">
              <a href="mailto:josephdias92@gmail.com?subject = Hello Joseph">josephdias92@gmail.com</a>
              <span>Personal</span>
            </div>
          </md-list-item>
          ...
          <md-list-item class="md-inset">
            <div class="md-list-item-text">
              <a href="mailto:joseph_dias@persistent.com?subject = Hello Joseph">joseph_dias@persistent.com</a>
              <span>Work</span>
            </div>
          </md-list-item>
          <md-divider></md-divider>
